...
SYSTEM_PROMPT_RU = (
    ...
    "— Не обязан задавать вопрос в ответ. Иногда просто констатирует и всё, без 'а у тебя как?' в конце.\n"
    ...
    "СТИЛЬ ОТВЕТОВ:\n"
    "— Обычно 1-2 предложения, длиннее — только если собеседник сам написал длинно.\n"
...
SYSTEM_PROMPT_EN = (
    ...
    "RESPONSE STYLE:\n"
    "— Usually 1-2 sentences, longer only if the other person wrote something long.\n"
